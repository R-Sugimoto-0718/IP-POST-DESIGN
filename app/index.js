...
export default class DejimonApp extends Component {
        ...
        <Animated.View
          style={{
            ...
            <Svg height={height+50} width={width}>
              ...
              <Image
                href={require('../assets/dejimon1.jpg')}
                width={width}
                height={height+50}
        ...
        <View style={{ height: height / 3, justifyContent: 'center' }}>
          <TapGestureHandler onHandlerStateChange={this.onStateChange}>
            <Animated.View
              ...
              <Text style={{ fontSize: 20, fontWeight: 'bold' }}>SIGN IN WITH FACE BOOK</Text>
            </Animated.View>
          </TapGestureHandler>
          <Animated.View
            style={{...styles.button, backgroundColor: '#3DC0B1', opacity: this.buttonOpacity, transform: [{ translateY: this.buttonY }] }}>
